...
export default function QuickDrawer({ type, onClose }) {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      productService.search({ search: query || undefined, limit: 4 }).then((response) => setMatches(response.items));
    }, 150);
